...
| Joint method improves quality | both operators | held-out main | T2 | only observed datasets/metrics | complete |
| Joint method reduces logical access | replay | held-out main | T2/F3 | stopping-depth reduction, not latency | complete |
