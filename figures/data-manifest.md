...
| F5 | realized Dense drift and Sparse reordering | `figures/data/mechanism-distributions.csv` | `figures/mechanism/fig_mechanism_distributions.py` | generated (PNG/SVG/PDF; appendix) |
